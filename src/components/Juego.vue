...
export default {
  ...
  methods: {
    ...
    incrementarPuntaje() {
      if (
        this.array[0].id == this.array[1].id ||
        this.array[0].id == this.array[2].id ||
        this.array[1].id == this.array[2].id
      ) {
    ...
    async obtenerPokemonsB() {
      ...
      await this.obtenerArregloPokemons();
    ...
    cambiarNombres() {
      this.nombre1 = this.array[0].nombre;
      this.nombre2 = this.array[1].nombre;
      this.nombre3 = this.array[2].nombre;
    },
    imagenFuente() {
      if (this.NoestaJugando == true) {
        return require("../assets/fondonegro.jpg");
      } else {
        return `https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/dream-world/${this.array[0].id}.svg`;
      }
    },
    imagenFuente1() {
      if (this.NoestaJugando == true) {
        ...
        return `https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/dream-world/${this.array[1].id}.svg`;
      }
    },
    imagenFuente2() {
      if (this.NoestaJugando == true) {
        ...
        return `https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/dream-world/${this.array[2].id}.svg`;
      }
    },
  },
};
